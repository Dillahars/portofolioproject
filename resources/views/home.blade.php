  ...
  <main>
    ...
    <section id="skills" aria-label="Skills Summary">
      ...
      <div class="skills-list">
        ...
        <div class="skill" role="listitem" tabindex="0" aria-label="Laravel">
        ...
        <div class="skill" tabindex="0" aria-label="Node.js">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
    ...
    <section id="skills" aria-label="Skills Summary">
      <h2>Tools</h2>
        ...
        <div class="skills-list">
        <div class="skill" tabindex="0" aria-label="Git">
        ...
        <div class="skill" tabindex="0" aria-label="VS Code">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
        ...
        <div class="skill" tabindex="0" aria-label="Figma">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
